...
@section('meta')
    ...
    <meta name="description" content="Paradis Déco : découvrez notre collection complète de meubles, luminaires, tapis et accessoires pour sublimer votre intérieur en Tunisie.">
    <meta name="keywords" content="boutique déco en ligne Tunisie, décoration intérieure, meubles tunisiens, luminaires, tapis artisanaux, accessoires maison, artisanat tunisien, ameublement moderne, cadeaux maison">
    ...
    <section class="py-8 sm:py-12 bg-white">
        <div class="container mx-auto px-4 sm:px-6">
            ...
            <div x-data="{ mobileFiltersOpen: false }" class="mb-6 md:hidden">
                ...
                <div x-show="mobileFiltersOpen" x-transition class="fixed inset-0 z-50 overflow-y-auto">
                    <div class="flex min-h-screen">
                        <div class="relative w-full max-w-xs bg-white shadow-xl ml-auto">
                            <div class="sticky top-0 z-10 bg-white border-b border-gray-100 px-6 py-4 flex justify-between items-center">
                                ...
                                <button @click="mobileFiltersOpen = false" class="p-2 rounded-md text-gray-400 hover:text-gray-500">
                            ...
                            <div class="p-6 overflow-y-auto h-[calc(100vh-60px)]">
                                ...
                                <div class="md:hidden sticky bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 py-4">
                                    <button @click="mobileFiltersOpen = false" class="w-full bg-primary text-white py-3 rounded-lg font-medium hover:bg-primary-dark transition">
                                        Appliquer
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="p-4">
                                    <div class="mb-3">
                                        ...
                                        <p class="text-gray-500 text-xs sm:text-sm line-clamp-2 mb-2">
                                            {{ $product->description ? Str::limit(strip_tags($product->description), 80) : 'Produit décoratif moderne et élégant disponible chez Paradis Déco.' }}
                                        </p>
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <button aria-label="Ajouter {{ $product->name }} au panier"
                                                ...
                                                data-image="{{ asset('storage/' . ($product->image_avant ?? ($product->images[0] ?? ''))) }}"
                                                data-stock="{{ $product->stock }}"
                                                class="cursor-pointer flex items-center justify-center gap-1 bg-black hover:bg-gray-800 text-white p-2 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 hover:shadow-md"
