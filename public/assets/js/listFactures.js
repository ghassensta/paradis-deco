...
$(function () {
  ...
  var dt_order_table = $('.datatables-invoice'),
  ...
  if (dt_order_table.length) {
    var dt_products = dt_order_table.DataTable({
      ajax: assetsPath + 'json/ecommerce-customer-invoice.json', // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output = '<a href="voir.html?id='+$order_id+'"><span>#' + $order_id + '</span></a>';
            return $row_output;
          }
        },
        {
          ...
          },       
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="voir.html?id='+full['id']+'" class="dropdown-item">Voir</a>' +
      ...
      buttons: [
        ...
        {
            text: '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Ajouter Facture</span>',
